...
Phase 1: Core Engine (Cốt lõi Logic & Dữ liệu) - BẢN V3 [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓] 100%
...
Phase 2: Advanced Implementation (Giao diện UI & Đa luồng) [▓▓▓▓▓░░░░░░░░░░░░░░░] 25%
...
Gọi SessionManager lấy User hiện tại.
Check User.canAfford(amount) xem ví đủ tiền không.
Try-Catch gọi Product.placeBid(). Nếu Product ném ra Exception (lỗi giá thấp, tự
